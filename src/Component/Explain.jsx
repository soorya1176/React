  ...
  <tbody>
    {Array.map((item,index)=>{
        return (
            ...
            <tr>
                <td>{index + 1}</td>
                <td ><img class="rounded-circle" style={{height:"35px"}} src={item.img}/></td>
                <td>{item.Name}</td>
                <td>{item.Phone}</td>
                <td>{item.Email}</td>
                <td>
                <button className="btn m-1 btn-success" data-mdb-toggle="modal" data-mdb-target={`#view${index}`}>View</button>
                <button className="btn m-1 btn-primary" data-mdb-toggle="modal" data-mdb-target="#editModal">Edit</button>
                <button className="btn m-1 btn-danger">Delete</button>
                </td>
            </tr>
        <div class="modal fade" id={`view${index}`} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img style={{height:"200px"}} src={item.img}></img>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      autoComplete="off"
    >
      <TextField id="outlined-basic" label="Name" value={item.Name} variant="outlined" /><br></br>
